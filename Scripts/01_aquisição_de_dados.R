#### Potencial de regenerabilidade de acordo com a presença de dispersores: morcegos, primatas, roedores e aves###
#### SCRIPT PARA ORGANIZAÇÃO DOS DADOS QUE SERÃO USADOS NO PROJETO####
## Gupo guabiroba##
...
# set o diretorio
setwd("C:/Users/setsu/OneDrive/Documentos/GitHub/potencial_de_regenerabilidade_x_dispersores")
